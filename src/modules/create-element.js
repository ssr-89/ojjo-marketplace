...
function createCardProduct(
  ...
  if (imgOne !== null) {
    ...
    cardImgOne.src = "https://i.ibb.co/bKqYPvf/not-img.jpg";
  }
  ...
  if (imgTwo !== null) {
    ...
    cardImgTwo.src = "https://i.ibb.co/bKqYPvf/not-img.jpg";
  }
  ...
  if (imgThree !== null) {
    ...
    cardImgThree.src = "https://i.ibb.co/bKqYPvf/not-img.jpg";
  }
  ...
  if (imgFour !== null) {
    ...
    cardImgFour.src = "https://i.ibb.co/bKqYPvf/not-img.jpg";
  }
...
export function createCardProductList(parent, productCard, { cardId, brand, type, price, img }) {
  ...
  if (img !== null) {
    ...
    productListCardLinkImg.src = 'https://i.ibb.co/bKqYPvf/not-img.jpg';
  }
